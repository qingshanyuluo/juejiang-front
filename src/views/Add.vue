<template>
    <div>
        <header>
			<div style=" background: #f5f5f5;"><van-icon size="30" @click="back" color="darkgray" style=" background: #f5f5f5;" name="arrow-up" /></div>
        ...
        <main>
<!--            <div class="sort-wrap">
                <div class="items-sort" v-for="(items,index) in sortList" :key="index">
            ...
            <div class="diy-wrap">
                ...
                <div class="diy-content">
					...
					<div class="diy-items">
					    ...
					    <span>我要试试妆</span><!-- 妆容部分，暂不使用 -->
					</div>
					<div class="diy-items">
					    <div>
					
					    </div>
					    <span>我该怎么画</span><!-- 妆容部分，暂不使用 -->
					</div>
                </div>
            </div>
            <!-- 我的开封 -->
