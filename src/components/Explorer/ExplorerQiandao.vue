<template>
  <div>
    ...
    <header>
      ...
      <van-button icon="flag-o" round type="info" size="small" @click="a">{{sign}}</van-button>
    </header>
    ...
    <main>
      <div class="days-wrap">
        ...
        <div>
          ...
          <div class="calendar-items" v-for="(items,index) in calendarList" :key="index" @click="signIn(items.isCheck)">
            <div class="calendar">
              +{{items.integral}}
            </div>
            <span>
