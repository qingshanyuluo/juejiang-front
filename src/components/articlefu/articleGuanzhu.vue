<template>
  ...
  <span   v-for="(arti,i) in sites" v-bind:key="i">
    ...
    <van-row>
      <van-col span="2"
        ><van-image  style="margin-left: 9px ; margin-top: -10px;"
          round
          fit="fill"
          width="1.5rem"
          height="1.5rem"
        ...
        /></van-col
      ><van-col span="3"><h6 style="font-weight:normal; color: darkgrey;margin-top: -4px;  margin-right: -8px;">{{arti.writername}}</h6></van-col>
